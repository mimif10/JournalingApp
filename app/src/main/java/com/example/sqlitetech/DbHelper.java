...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public boolean addOne(NewEntryModel newEntry){
        ...
        // D
        cv.put(COL_NEW_ENTRY_NAME, NewEntryModel.getjEntryName()); // associate a column name with a string
        cv.put(COL_IS_COMPLETED, NewEntryModel.isCompleted());
    ...
    public List<NewEntryModel> getAllList()
    {
        // create a return list (define the list)
        List<NewEntryModel> returnList = new ArrayList<>();
